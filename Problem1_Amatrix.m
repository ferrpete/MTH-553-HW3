...
function A = Problem1_Amatrix(n_interior,h,dt,theta)
...
values(1:n_interior-1) = -theta*(dt/(h^2));
values(n_interior:2*n_interior-1) = 1 + 2*theta*(dt/(h^2));
values(2*n_interior:3*n_interior-2) = -theta*(dt/(h^2));
